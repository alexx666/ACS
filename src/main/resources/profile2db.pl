...
profile2db.pl - Load session metadata from cxtracker into a db
...
sub get_table_name {
  ...
  # my $tablename = "session_" . sanitize_table_name($HOSTNAME); 	 
  return $tablename;
}
